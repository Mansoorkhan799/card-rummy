      ...
      <article className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <ol className="list-decimal pl-6 text-gray-300 mb-6 space-y-3">
            ...
            <li>Click the big "Download APK" button (usually orange or green) - or visit our <a href="https://pkcardrummy.com/?from_gameid=6191689&channelCode=6113272" target="_blank" rel="noopener noreferrer" className="text-[#FFA500] hover:underline font-semibold">download page</a></li>
          ...
          <ol className="list-decimal pl-6 text-gray-300 mb-6 space-y-3">
            ...
            <li>Tap the downloaded APK file (named something like "CardRummy_v1.231.apk")</li>
          ...
          <div className="mt-12 text-center">
            ...
            >
              Download Card Rummy APK v1.231 - Start Your Journey
            </a>
          </div>
        </div>
        ...
        <aside className="mt-16 pt-8 border-t border-gray-700">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Link href="/blog/create-card-rummy-account-and-login" className="block p-6 bg-purple-800/30 rounded-lg hover:bg-purple-800/50 transition-colors">
