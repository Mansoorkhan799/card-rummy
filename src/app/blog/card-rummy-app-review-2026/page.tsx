      ...
      <article className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <ul className="list-disc pl-6 text-gray-300 mb-6 space-y-2">
            ...
            <li>You're willing to set and stick to limits (see our <Link href="/blog/responsible-gaming-guide-card-rummy" className="text-[#FFA500] hover:underline font-semibold">responsible gaming guide</Link>)</li>
            <li>You understand the legal ambiguity (read our <Link href="/blog/is-card-rummy-safe-legal-pakistan" className="text-[#FFA500] hover:underline font-semibold">safety and legal guide</Link>)</li>
