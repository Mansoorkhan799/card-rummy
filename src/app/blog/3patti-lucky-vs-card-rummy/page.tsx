...
export const metadata: Metadata = {
  title: '3Patti Lucky vs Card Rummy – Which Is Better?',
      ...
      <article className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="bg-orange-600/20 border border-orange-500 rounded-lg p-6 my-8">
            ...
            <p className="text-gray-300">
              Both apps involve real money gambling and operate in a legal gray area in Pakistan. Only play with money you can afford to lose, set strict limits, and play responsibly. See our <Link href="/blog/responsible-gaming-guide-card-rummy" className="text-[#FFA500] hover:underline font-semibold">responsible gaming guide</Link> for safety tips.
            </p>
          </div>
